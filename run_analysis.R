#Created by Suresh Koneti 03/06/2016
...
run_analysis <- function(){
  ...
  # merging test and training data and then name them
  ...
  # creating a dataset grouped by subject and activity after applying standard deviation and average calculations
  library(data.table)
